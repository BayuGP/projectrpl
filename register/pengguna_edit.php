...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css">
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-md-6">
                          <a href="../register/pengguna.php" class="btn btn-primary box-title" style="font-size: 20px; padding:10px 20px 10px 20px; background-color: #1e3f66;"><i class="fa fa-arrow-left fa-fw"></i> Kembali</a>
                    </div>
                    <div class="col-md-6 text-right">
                        <button id="btn-refresh" class="btn btn-primary box-title text-right" title="Refresh Data" style="font-size: 20px; padding:10px 20px 10px 20px; background-color: #1e3f66;"><i class="fa fa-refresh" id="ic-refresh"></i></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                    <div class="white-box" style="height: 550px; margin-bottom: -700px;">
                <form method="post" action="">
                          <p style="text-align: center; font-size: 30px; font-weight: 500; ">Edit Pengguna Laundry PNB</p>
