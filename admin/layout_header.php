...
<head>
    ...
    <title>Aplikasi Laundry PNB</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Alatsi&family=Fredoka+One&family=Viga&display=swap" rel="stylesheet">
...
<body class="fix-header" >
    ...
    <div id="wrapper" >
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0" >
            <div class="navbar-header" >
                <div class="top-left-part" > 
                    ...
                    <!-- Logo -->
                    <img src="../assets/image/istockphoto-1253375551-612x612-removebg-preview.png" style="width: 40px; margin-top:8px; margin-left: 10px; float: left;" alt="">
                    <a class="logo"  style="font-family: 'Viga', sans-serif;" href="index.php">
                        <!-- Logo icon image, you can use font-icon also -->
                        <b style="color:black; font-size: 25px;">
                            LAUNDRY PNB
                        </b>
                    </a>
                </div>
     ...
     <ul class="nav navbar-top-links navbar-right pull-right" >
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="../assets/image/1662730841898.png" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">ADMIN</b></a>
                    </li>
                </ul>
            </div>
            </div>
        ...
        <div class="navbar-default sidebar"  role="navigation">
            <div class="sidebar-nav slimscrollsidebar" >
                ...
                <ul class="nav" id="side-menu" style="font-size: 15px !important;">
                    <li style="padding: 70px 0 0;" >
                        <a href="index.php" class="waves-effect <?php if($title=='dashboard'){echo 'active';} ?>"><i class="fa fa-tachometer fa-fw" aria-hidden="true"></i>Home</a>
                    </li>
                    <li>
                ...
                <div class="center p-20">
                     <a href="logout.php" class="btn btn-danger btn-block waves-effect waves-light" style="color: white; background-color:#7460ee; border: 1px solid #7460ee;">Logout</a>
                 </div>
            </div>
